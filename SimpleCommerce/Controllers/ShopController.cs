...
namespace SimpleCommerce.Controllers
{
    public class ShopController : ControllerBase
    {
        ...
        private IActionResult IyzicoPayment(Order order)
        {
            ...
            buyer.RegistrationAddress = order.Customer.BillingDistrict + " " + order.Customer.BillingStreet + " " + order.Customer.BillingAdress;
            ...
            shippingAddress.Description = order.Customer.ShippingDistrict + " " + order.Customer.ShippingStreet + " " + order.Customer.ShippingAdress;
            ...
            billingAddress.Description = order.Customer.BillingDistrict + " " + order.Customer.BillingStreet + " " + order.Customer.BillingAdress;
