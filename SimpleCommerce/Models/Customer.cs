...
namespace SimpleCommerce.Models
{
    public class Customer
    {
        ...
        [Display(Name = "Fatura Mahalle")]
        [StringLength(200)]
        public string BillingDistrict { get; set; }
        [Display(Name = "Fatura Sokak")]
        [StringLength(200)]
        ...
        [Display(Name = "Teslimat Mahalle")]
        [StringLength(200)]
        public string ShippingDistrict { get; set; }
        [Display(Name = "Teslimat Sokak")]
        [StringLength(200)]
        public string ShippingStreet { get; set; }
        [Display(Name = "Teslimat Adres")]
        [StringLength(200)]
        public string ShippingAdress { get; set; }
        [Display(Name = "Teslimat Posta Kod")]
        [StringLength(200)]
